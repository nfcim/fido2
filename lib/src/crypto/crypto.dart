...
class RustCrypto {
  ...
  static bool verifyHmacSha256(
          List<int> key, List<int> message, List<int> signature) =>
      _call({
        'op': 'hmac_verify',
        'key': key,
        'message': message,
  ...
  static Uint8List hkdfSha256(List<int> key,
  ...
  static Uint8List aes256Cbc(List<int> key, List<int> message,
          {required List<int> iv, bool decrypt = false}) =>
      _call({
  ...
  static Uint8List encapsulatePin(List<int> peerPublicKey, int version) =>
      _call(
          {'op': 'pin_encapsulate', 'key': peerPublicKey, 'version': version});
  ...
  static bool verify(String algorithm, List<int> key, List<int> message,
          List<int> signature,
          {String encoding = 'raw',
