...
void main() {
  group('AuthenticatorInfo', () {
    test('Request', () {
      ...
      expect(request.encode(), equals([4]));
    });
    ...
    test('Response', () {
      ...
      var info = AuthenticatorInfo.decode(response);
  ...
  group('MakeCredential', () {
    ...
    test('Response', () {
      ...
      var response = MakeCredentialResponse.decode(responseBytes);
      ...
      expect(
        credentialId,
        equals(hex.decode('f1d0c41d1f054238b971e164e64941a8')),
      );
  ...
  group('GetAssertion', () {
    ...
    test('Response', () {
      ...
      var response = GetAssertionResponse.decode(responseData);
  ...
  group('ClientPin', () {
    test('Request1', () {
      var request = ClientPinRequest(
        subCommand: ClientPinSubCommand.getKeyAgreement.value,
        pinUvAuthProtocol: 2,
      );
      expect(request.encode(), equals(hex.decode('06A201020202')));
    });
    ...
    test('Response', () {
      ...
      var clientPinResponse = ClientPinResponse.decode(response);
